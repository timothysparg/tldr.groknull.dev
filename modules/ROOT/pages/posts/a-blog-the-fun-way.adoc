...
:icons: font
:article-card-image-light: image$a-blog-the-fun-way-light.png
:article-card-image-dark: image$a-blog-the-fun-way-dark.png
:toc: macro
...
[TLDR]
====
__putting disparate technologies together always takes longer than expected__
====
